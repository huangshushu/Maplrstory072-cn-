...
function action(mode, type, selection) {
	...
	status--;
    if (status == 0) {
	cm.sendSimple("Have you heard of the beach with a spectacular view of the ocean called #bFlorina Beach#k, located a little far from Ludibrium? I can take you there right now for either #b1,500 mesos#k, or if you have a #bVIP Ticket to Florina Beach#k with you, in which case you'll be there for free.\r\n\r\n#L0##b I'll pay 1200 mesos.#l\r\n#L1# I have a VIP Ticket to Florina Beach.#l\r\n#L2# What is a VIP Ticket to Florina Beach#k?#l");
    } else if (status == 1) {
	if (selection == 0) {
	    cm.sendYesNo("You want to pay #b1,500 mesos#k and leave for Florina Beach? Okay!! Please be aware that you may be running into some monsters around there, though, so make sure not to get caught off-guard. Okay, would you like to head over to Florina Beach right now?");
	} else if (selection == 1) {
	    status = 2;
