...
function action(mode, type, selection) {
	...
	if (selection == 0) { //ZPQ
		...
		cm.sendYesNo("如果你想得到更多的#b火焰的眼#k，你需要给我 #b30个僵尸丢失的金齿#k。你有更多的金牙要给我吗？");
	    } else if (cm.haveItem(4031061) && cm.haveItem(4031062)) {
		// check if quest is complete, if so reset it (NOT COMPLETE)
		cm.sendYesNo("好吧，你已经完成了早期的阶段。现在，努力一点我可以帮你得到进入扎昆祭台所需要的火焰的眼。但是，我的牙齿最近有点疼。你见过一个牙医在冒险岛世界的故事吗？哦，我听说僵尸们有几颗金牙。我需要你找到#b30个僵尸丢失的金齿#k 。这样我就可以自己制造一些假牙。然后我可以帮你拿到你想要的物品\r\n任务要求：\r\n#i4000082##bx30个");
		...
		cm.dispose();
	    	...
	    	cm.sendYesNo("你想收买我？哈哈，可以啊！但你必须给我#e300,000,000#n金币，我就可以让你直接跳过任务。");
		status = 3;
	    }
	}
    } else if (status == 2) {
	if (stage == 1) {
		...
		if (cm.haveItem(4031061,1) && cm.haveItem(4031062,1) && cm.haveItem(4000082,30)) { // take away items, give eyes of fire, complete quest
		    ...
		    cm.sendNext("我不认为你带来了30个僵尸丢失的金牙呢……。请快点找来，我就会给你需要的东西。");
		    cm.dispose();
		}
	    } else {
