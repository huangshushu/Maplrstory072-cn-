            ...
            if (selection == 0) {
                ...
                for (var i = 0; i < 3; i++) {
                    ...
                    if (currentpet != null && pet == null) {
                        if (currentpet.getSummoned() && currentpet.getPetItemId() > 5000028 && currentpet.getPetItemId() < 5000036 && currentpet.getLevel() >= 15) {
                            pet = currentpet;
                            break;
                        }
                    }
                ...
                if (pet == null || !cm.haveItem(5380000, 1)) {
                    cm.sendOk("你不符合要求。你需要 #i5380000##t5380000#, 以及任何一个 #d#i5000029##t5000029##k, #g#i5000030##t5000030##k, #r#i5000035##t5000035##k, #b#i5000032##t5000032##k, 或 #e#i5000033##t5000033##n 宠物等级15级以上，再来与我对话吧。");
                    cm.dispose();
                } else {
