...
function action(mode, type, selection) {
	...
	if (cm.isLeader()) { // Leader
		...
		if (cm.haveItem(4001022,24)) { // Clear stage
		    cm.sendNext("恭喜！你已经通过了第五阶段。快点现在，去第6阶段。");
		...
		cm.sendOk("欢迎来到第五阶段。#b废弃的塔#k请收集#r#t4001022##k 来找我即可完成任务。");
		eim.setProperty("stage5leader","done");
		cm.safeDispose();
	    }
	} else { // Members
	    cm.sendNext("欢迎来到第五阶段。#b废弃的塔#k请收集#r#t4001022##k给你的队长，然后叫队长来找我即可完成任务。");
	    cm.safeDispose();
	}
    } else {
	cm.sendNext("恭喜！你已经通过了第五阶段。快点现在，去第6阶段。");
