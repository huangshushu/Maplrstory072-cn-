...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getMapId() == 251000000) {
            cm.sendYesNo("怎么样？我从 " + btwmsg + " 再到现在。我的速度很快的吧，如果你想返回 #b" + menu[3] + "#k ，那么我们就立刻出发，不过还是得给我一些辛苦费，价格是 #b" + cost[3] + " 金币#k。");
        } else {
